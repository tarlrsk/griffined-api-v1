...
namespace griffined_api.Services.RegistrationRequestService
{
    public interface IRegistrationRequestService
    {
        ...
        Task<ServiceResponse<CompletedCancelledResponseDto>> GetCompletedRequest(int requestId);
        Task<ServiceResponse<CompletedCancelledResponseDto>> GetCancelledRequest(int requestId);
    }
}